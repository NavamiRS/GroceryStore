...
public class ManageProductPage {
	...
	public void oilImageUpload() throws InterruptedException, AWTException 
	{
		...
		js.executeScript("arguments[0].click();",image_Upload);
		 ...
		 gu.clickToTheElement(image_Upload, driver); gu.mediumDelay(3000);
	...
	public boolean oilImageUploadFromRemote() throws InterruptedException, AWTException 
	{ 	javascriptexe();
